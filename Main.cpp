...
private:
    ...
    void createInstance() {
        ...
        appInfo.pApplicationName = "Hello World C++";
    ...
    void createGraphicsPipeline() {
        ...
        auto bgVertShaderCode = readFile("shaders/background.vert.spv");
        auto bgFragShaderCode = readFile("shaders/background.frag.spv");

        VkShaderModule bgVertShaderModule = createShaderModule(bgVertShaderCode);
        VkShaderModule bgFragShaderModule = createShaderModule(bgFragShaderCode);

        VkPipelineShaderStageCreateInfo bgVertStageInfo{};
        bgVertStageInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
        bgVertStageInfo.stage = VK_SHADER_STAGE_VERTEX_BIT;
        bgVertStageInfo.module = bgVertShaderModule;
        bgVertStageInfo.pName = "main";

        VkPipelineShaderStageCreateInfo bgFragStageInfo{};
        bgFragStageInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
        bgFragStageInfo.stage = VK_SHADER_STAGE_FRAGMENT_BIT;
        bgFragStageInfo.module = bgFragShaderModule;
        bgFragStageInfo.pName = "main";

        VkPipelineShaderStageCreateInfo bgShaderStages[] = { bgVertStageInfo, bgFragStageInfo };

        VkPipelineVertexInputStateCreateInfo bgVertexInputInfo{};
        bgVertexInputInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_STATE_CREATE_INFO;
        ...
        bgPipelineInfo.pStages = bgShaderStages;
        bgPipelineInfo.pVertexInputState = &bgVertexInputInfo;
        ...
        vkDestroyShaderModule(device, bgFragShaderModule, nullptr);
        vkDestroyShaderModule(device, bgVertShaderModule, nullptr);

        // Create torus pipeline
        auto torusVertShaderCode = readFile("shaders/torus.vert.spv");
        auto torusFragShaderCode = readFile("shaders/torus.frag.spv");

        VkShaderModule torusVertShaderModule = createShaderModule(torusVertShaderCode);
        VkShaderModule torusFragShaderModule = createShaderModule(torusFragShaderCode);

        VkPipelineShaderStageCreateInfo torusVertStageInfo{};
        torusVertStageInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
        torusVertStageInfo.stage = VK_SHADER_STAGE_VERTEX_BIT;
        torusVertStageInfo.module = torusVertShaderModule;
        torusVertStageInfo.pName = "main";

        VkPipelineShaderStageCreateInfo torusFragStageInfo{};
        torusFragStageInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
        torusFragStageInfo.stage = VK_SHADER_STAGE_FRAGMENT_BIT;
        torusFragStageInfo.module = torusFragShaderModule;
        torusFragStageInfo.pName = "main";

        VkPipelineShaderStageCreateInfo torusShaderStages[] = { torusVertStageInfo, torusFragStageInfo };

        VkVertexInputBindingDescription torusBindingDescription{};
        torusBindingDescription.binding = 0;
        torusBindingDescription.stride = 6 * sizeof(float);
        torusBindingDescription.inputRate = VK_VERTEX_INPUT_RATE_VERTEX;

        VkVertexInputAttributeDescription torusAttributeDescriptions[2]{};
        torusAttributeDescriptions[0].binding = 0;
        torusAttributeDescriptions[0].location = 0;
        torusAttributeDescriptions[0].format = VK_FORMAT_R32G32B32_SFLOAT;
        torusAttributeDescriptions[0].offset = 0;
        torusAttributeDescriptions[1].binding = 0;
        torusAttributeDescriptions[1].location = 1;
        torusAttributeDescriptions[1].format = VK_FORMAT_R32G32B32_SFLOAT;
        torusAttributeDescriptions[1].offset = 3 * sizeof(float);

        VkPipelineVertexInputStateCreateInfo torusVertexInputInfo{};
        torusVertexInputInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_STATE_CREATE_INFO;
        torusVertexInputInfo.vertexBindingDescriptionCount = 1;
        torusVertexInputInfo.pVertexBindingDescriptions = &torusBindingDescription;
        torusVertexInputInfo.vertexAttributeDescriptionCount = 2;
        torusVertexInputInfo.pVertexAttributeDescriptions = torusAttributeDescriptions;
        ...
        torusPipelineInfo.pStages = torusShaderStages;
        torusPipelineInfo.pVertexInputState = &torusVertexInputInfo;
        ...
        vkDestroyShaderModule(device, torusFragShaderModule, nullptr);
        vkDestroyShaderModule(device, torusVertShaderModule, nullptr);
    }
